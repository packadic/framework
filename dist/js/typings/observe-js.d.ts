...
declare module observejs {
    ...
    export var PathObserver: PathObserver_static;
    export var ArrayObserver: ArrayObserver_static;
    export var ObjectObserver: ObjectObserver_static;
    export var CompoundObserver: CompoundObserver_static;
    export var ObserverTransform: ObserverTransform_static;
    export var Path: Path;

    export interface IPathObserver extends PathObserver_instance {}
    export interface IObjectObserver extends ObjectObserver_instance {}
    export interface ICompoundObserver extends CompoundObserver_instance {}
}
