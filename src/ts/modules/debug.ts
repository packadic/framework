...
import {getViewPort,isTouchDevice,getRandomId,round} from './../modules/utilities';
import {create,DeferredInterface,when} from './../modules/promise';
...
export class Debug {
    ...
    public log(...args:any[]) {
        ...
        if (elapsedTime > 1) {
            elapsedTime = round(elapsedTime / 1000, 2);
        }
