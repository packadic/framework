...
var layout;
(function (layout_1) {
    var debug = packadic.debug;
    var Component = packadic.components.Component;
    var Components = packadic.components.Components;
    var plugins = packadic.plugins;
    var getViewPort = packadic.getViewPort;
    ...
    var LayoutComponent = (function (_super) {
        ...
        LayoutComponent.prototype._initSidebarSubmenus = function () {
            ...
            el.sidebar.on('click', 'li > a', function (e) {
                var $this = $(this);
                if (getViewPort().width >= self.getBreakpoint('md') && $this.parents('.page-sidebar-menu-hover-submenu').size() === 1) {
                    return;
                }
                if ($this.next().hasClass('sub-menu') === false) {
                    if (getViewPort().width < self.getBreakpoint('md') && el.sidebarMenu.hasClass("in")) {
