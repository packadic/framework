...
declare module "observe-js" {
    export var PathObserver: observejs.PathObserver_static;
    export var ArrayObserver: observejs.ArrayObserver_static;
    export var ObjectObserver: observejs.ObjectObserver_static;
    export var CompoundObserver: observejs.CompoundObserver_static;
    export var ObserverTransform: observejs.ObserverTransform_static;
